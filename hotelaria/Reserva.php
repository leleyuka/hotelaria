...
<body>	
	...
	<div class="row text-center" style="margin-top: 15px;">
		<a href="index.php"><button class="btn btn-lg btn-primary">Voltar as opções</button></a>

		<?php if(count($_SESSION['carrinho'])> 0 ) { ?>
		<a href="FinalizarReserva.php"><button class="btn btn-lg btn-success">Finalizar Reserva</button></a>
		<?php }?>
	</div>
