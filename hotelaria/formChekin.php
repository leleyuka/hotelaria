...
<body>
        ...
        <div class="container">
        <h1 style="text-align:center;"><mark style="background-color:#ce992f; border-radius:15px;">Check-In</mark></h1></br>
        <h2 style="text-align:center;"><mark style="background-color:#ce992f; border-radius:15px;">Preencha os dados:</mark></h2>
            <form name="Formchekin" method="post" action="FazerChekin.php">
                ...
                <button type="submit" class="btn btn-lg btn-default">
                    <span class="glyphicon glyphicon-pencil"> Efetuar Check-in </span>
                </button>
            </form>
        </div>
